    ...
    <div className="flex flex-col justify-center items-center w-full m-3">
      <div className="w-2/3 shadow-lg p-5 pr-5">
        <h2 className="text-center text-3xl font-semibold">
          {board.title}글의 수정페이지
        </h2>
        <div className="flex justify-center relative mb-10 flex-row items-center ">
          <div className="p-6 font-bold">게시글 번호</div>
          <div className="p-3 rounded-r border border-solid shadow-md">
            {board.boardNo}
          </div>
        </div>

        <div className="flex justify-evenly mb-1/4">
          <div className="relative mb-4 flex  flex-row">
            <div className="w-1/8 p-1 text-center font-bold">분류 : </div>
            <select
              id="category"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              className="w-1/8  p-1 rounded-r border border-solid border-neutral-300 shadow-md text-center"
              name="category"
              type={'text'}
          ...
          <div className="relative mb-4 flex flex-row">
            <div className="w-1/8 p-1 text-center font-bold">제목 : </div>
            <input
              className="p-1 rounded-r border border-solid border-neutral-300 shadow-md"
              name="title"
              type={'text'}
              value={board.title}
              onChange={handleChangeBoard}
